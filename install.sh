...
# NZB installer — https://github.com/iletai/AI-Agent-Assistant
# Usage: curl -fsSL https://raw.githubusercontent.com/iletai/AI-Agent-Assistant/main/install.sh | bash
...
if command -v copilot &>/dev/null; then
  ...
  warn "  ⚠ Copilot CLI not found — you'll need it before starting NZB"
